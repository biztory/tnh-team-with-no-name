...
def to_bool(value):
    """
    Converts a value to a boolean. It accepts various types of inputs, including strings, integers, floats, and booleans. Returns False if unknown.

    True values: "true", "1", "yes", "y", "on"
    False values: "false", "0", "no", "n", "off"

    Note that this function was generated by ChatGPT.
    """
